...
const Navbar = (darkMode, toggleDarkMode) => {
  ...
  return (
    <Nav>
      <NavbarContainer>
        <NavLogo to='/'>
          <a style={{ display: "flex", alignItems: "center", color: "white", marginBottom: '20;', cursor: 'pointer', fontSize: '1.5rem', fontWeight: 'bold' }}>
             <Span>Portfolio</Span>
          </a>
        </NavLogo>
        <MobileIcon>
        ...
        </ButtonContainer>
        {
          ...
          {/*}  <MobileLink href='#projects' onClick={() => {
            ...
            <GitHubButton style={{padding: '10px 21px',background: `${theme.primary}`, color: 'white',width: 'max-content'}} href={Bio.github} target="_blank">Github </GitHubButton>
          </MobileMenu>
        }
      </NavbarContainer>
    </Nav>
